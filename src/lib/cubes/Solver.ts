...
export class Solver {
    ...
    private getPiece(number : number){

        const rubik : any = this.cube.getRubik();
        return rubik[number]
    }

    public getEdgeIndex(color1:Color, color2:Color):number{
    ...
    public solveWhiteEdge(color1:Color, color2:Color){
