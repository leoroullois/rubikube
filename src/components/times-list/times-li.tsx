...
const TimesLi: FC<IProps> = ({ time, ao5, ao12 }) => {
  return (
    <li className="flex flex-col justify-center items-center gap-y-3 p-4 w-48 bg-slate-400/20 dark:bg-slate-800/50 hover:dark:bg-slate-800/70 hover:bg-slate-400/30 rounded-lg border-4 border-gray-900/10 dark:border-gray-50/10 duration-150">
